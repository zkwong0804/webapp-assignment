<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Owner.Master" CodeBehind="CategoryUpdate.aspx.vb" Inherits="webapp_assignment.UpdateCategory" %>
            ...
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    <div class="bg-white p-5 contact-form">
                        ...
                        <div class="form-group">
                            <asp:Button ID="btnUpdate" runat="server" Text="Update category" />
                        </div>
                    </div>
                </div>
            </div>
